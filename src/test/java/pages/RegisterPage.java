...
public class RegisterPage extends PageBase{
    ...
    public void registerAs(String gender, String firstName, String lastName, int day,
                           String month, int year, String email, String companyName,
                           boolean wantsNewsletter, String password, String confirmedPassword) {
